discover_web_apps() {
    ...
    if command -v nginx >/dev/null 2>&1 && service nginx onestatus >/dev/null 2>&1 2>/dev/null; then
    ...
    if command -v apache2 >/dev/null 2>&1 && service apache2 onestatus >/dev/null 2>&1 2>/dev/null; then
    ...
    elif command -v httpd >/dev/null 2>&1 && service httpd onestatus >/dev/null 2>&1 2>/dev/null; then
