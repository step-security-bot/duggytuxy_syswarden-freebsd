show_alerts_dashboard() {
    ...
    # HOTFIX: Mawk (FreeBSD) Input Buffering Bypass via Function Wrapper
    ...
    # Multiplex rc.d Journal and Flat files safely without creating orphan processes
    (
        P1=""
        ...
        P2=""
        local LOGS=()
        # HOTFIX: Integration of all possible log targets across FreeBSD
    ...
    }
    {
        ...
        if ($0 ~ /SysWarden-BLOCK|SysWarden-GEO|SysWarden-ASN|Catch-All/) {
            ...
            # Universal Date Parsing (Supports ISO-8601 from FreeBSD 14.4+ and Legacy Syslog)
            ...
            # HOTFIX: Universal stdout flush (Works on FreeBSD awk)
            system("")
            next
        }
